...
export function createThemeFromColor(
  ...
  let primaryBackgroundColor = '#841209';
  ...
  const backgroundColorLighter1 = hsl(h, s, Math.min(l + 0.05, 1));
  const backgroundColorLighter2 = hsl(h, s, Math.min(l + 0.1, 1));
  const backgroundColorLighter3 = hsl(h, s, Math.min(l + 0.2, 1));
  const backgroundColorLighter4 = hsl(h, s, Math.min(l + 0.3, 1));
  const backgroundColorLighter5 = hsl(h, s, Math.min(l + 0.5, 1));

  const backgroundColorMore1 = isDark ? backgroundColorDarker1 : backgroundColorLighter1;
  const backgroundColorMore2 = isDark ? backgroundColorDarker2 : backgroundColorLighter2;
  const backgroundColorMore3 = isDark ? backgroundColorDarker3 : backgroundColorLighter3;
  const backgroundColorMore4 = isDark ? backgroundColorDarker4 : backgroundColorLighter4;
  const backgroundColorMore5 = isDark ? backgroundColorDarker5 : backgroundColorLighter5;

  const backgroundColorLess1 = !isDark ? backgroundColorDarker1 : backgroundColorLighter1;
  const backgroundColorLess2 = !isDark ? backgroundColorDarker2 : backgroundColorLighter2;
  const backgroundColorLess3 = !isDark ? backgroundColorDarker3 : backgroundColorLighter3;
  const backgroundColorLess4 = !isDark ? backgroundColorDarker4 : backgroundColorLighter4;
  const backgroundColorLess5 = !isDark ? backgroundColorDarker5 : backgroundColorLighter5;
  ...
  const theme = createTheme({
    ...
    backgroundColorLighter1,
    backgroundColorLighter2,
    backgroundColorLighter3,
    backgroundColorLighter4,
    backgroundColorLighter5,
  ...
  if (invertedTheme) {
    _t._invertedTheme = invertedTheme;
  }
